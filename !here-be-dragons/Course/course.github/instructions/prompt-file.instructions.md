...
- [ ] mode: agent or chat
- [ ] model: explicit provider/model@version format
...
**AUTHORITATIVE SOURCE**: Complete README update requirements are defined in [`.github/instructions/ai-assisted-output.instructions.md`](ai-assisted-output.instructions.md#placement-and-naming).

**Summary**: Add appropriate entry to `README.md` linking to the prompt file and its chat log for discoverability and traceability.
