---
marp: true
title: AI‑First vs. Prompt‑First Development
paginate: true
theme: default
---
...
::: notes
This deck introduces the distinction between AI‑First and Prompt‑First development.
The goal is to clarify strategy vs. interface, and show how both fit into modern AI‑assisted engineering.
:::
...
::: notes
AI‑First is the broad philosophy.
Prompt‑First is the tactical layer that enables predictable AI behavior.
You can do Prompt‑First without being AI‑First, but not the reverse.
:::
...
::: notes
This table is the heart of the comparison.
AI‑First is about organizational and architectural change.
Prompt‑First is about artifact discipline and predictable outputs.
:::
...
::: notes
AI‑First changes *what* you build and *how* you build it.
Prompt‑First changes *how you communicate intent* to the AI.
:::
...
Prompt‑First is necessary but not sufficient for AI‑First maturity.
:::
