...
**Delivery**: Emphasize that forking is a one-time setup step that enables all subsequent exercises.

**Transition**: "Let's understand why we fork instead of just cloning."
:::
...
**Demo Notes**: If showing live, navigate to GitHub and show the fork button.

**Common Questions**:

- "Can I just clone directly?" - Yes, but you can't push changes
- "What if the original updates?" - We'll cover syncing forks later

**Transition**: "Now let's walk through the forking process."
:::
...
1. **Navigate** to https://github.com/j0hnnymiller/AIASD-Brownfield-Example
...
```bash
# Fork the repository
gh repo fork j0hnnymiller/AIASD-Brownfield-Example

# Fork and clone in one step
gh repo fork j0hnnymiller/AIASD-Brownfield-Example --clone

# Fork with a custom name
gh repo fork j0hnnymiller/AIASD-Brownfield-Example \
  --fork-name my-brownfield-example
```
...
- "Upstream already exists" - Already configured, skip this step
- Name confusion - Remind that these are just labels
...
- **.github/instructions/**: Rules for AI assistants
...
2. **Slides/individual-slides/**:
   - Marp-formatted slide decks
   - Speaker notes included
   - Can be compiled to presentations
...
git checkout -b john-miller-workspace

# Or use a convention like firstname-lastname:
...
# Or see current branch in prompt
git status
```
...
git push -u origin yourname-workspace
...
# Should show your branch tracking origin/yourname-workspace
```

**Create a test commit to verify access:**
...
### Confirm All Three Repositories

**AIASD-Brownfield-Example Checklist:**

- [ ] Forked to your GitHub account
- [ ] Cloned locally
- [ ] `origin` points to YOUR fork
- [ ] `upstream` points to j0hnnymiller/AIASD-Brownfield-Example
- [ ] Can run `git fetch upstream`

**AI-Assisted-Software-Development Checklist:**
...
- Use these checklists to verify complete setup
- All three repositories should be ready
- Troubleshoot any issues before proceeding
- Get instructor help if stuck

**Interactive Activity**:

- Have students verify each item
...
- Review previous slides for setup steps
...
**Transition**: "With all three repositories ready, you're fully set for the entire course."
:::
...
1. ✅ Experiment freely in your brownfield fork
...
7. ✅ Create branches for different features

**Resources:**

- Brownfield Repository: https://github.com/j0hnnymiller/AIASD-Brownfield-Example
...
- Setup is complete for all three repositories
...
- Foundation for all future exercises

**Three Repository Summary**:

- **Brownfield fork**: Your independent practice workspace
- **Course Materials fork**: Your personal curriculum reference
- **20260323-AIASD**: Collaborative session workspace
...
- You have both independent and collaborative spaces

**Preview Next Content**:

- Next we'll explore the repository structures
- Then dive into the codebases
- Start making AI-assisted improvements
- Apply techniques in all three contexts

**Resources Note**:

- Bookmark all three repository URLs
- Reference when needed throughout course
- Forking applies to any open-source contribution
- Branching applies to team development

**Final Check**:

- "Any questions about repository setup?"
- Address any remaining concerns
- Ensure everyone has all three repos ready
- Verify everyone can push/pull

**Transition**: "Let's explore what's inside these repositories."
:::
...
**Brownfield Fork Workflow:**

```bash
# Fork via CLI
gh repo fork j0hnnymiller/AIASD-Brownfield-Example --clone

# Or fork via web + clone manually
git clone https://github.com/YOUR_USERNAME/AIASD-Brownfield-Example.git
cd AIASD-Brownfield-Example
...
**Course Materials Fork Workflow:**
...
**20260323-AIASD Clone and Branch Workflow:**
...
# Create and push your personal branch
git checkout -b yourname-workspace
git push -u origin yourname-workspace
...
**Save this slide for reference!**

::: notes
**Optional Reference Slide**

**Timing**: Optional, can skip in presentation
...
- Covers all three repository workflows

**Usage**:

- Keep this slide visible during exercises
- Students can refer back when needed
- Include in handout materials
- Helps students remember which commands for which repo

**Three Workflow Summary**:

- First section: Brownfield fork workflow (practice code)
...
- This is a pure reference slide
- Mention it's available but don't read through it
- Suggest students bookmark or screenshot
- Available in slide deck for later reference

**Transition**: End of repository setup module. Proceed to repository exploration or hands-on exercises.
:::
