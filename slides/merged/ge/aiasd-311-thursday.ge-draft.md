...
prompt: |
  Follow instructions in .github/prompts/merge-marp-decks.prompt.md with slides/manifests/ge/aiasd-311-thursday.ge.manifest.md.
started: "2026-05-04T00:30:00Z"
ended: "2026-05-04T00:50:00Z"
task_durations:
  - task: "manifest-driven merge"
    duration: "00:12:00"
  - task: "notes coverage validation and patch"
    duration: "00:06:00"
  - task: "provenance updates"
    duration: "00:02:00"
total_duration: "00:20:00"
ai_log: "ai-logs/2026/05/04/merge-marp-thursday-ge-20260504/conversation.md"
...
- MFC to WPF - Legacy Conversion

::: notes
This slide is part of the merged Course Modules section for the Thursday GE deck.
Use this slide to reinforce the core point, connect it to the previous slide, and set up the next transition.
Call out one practical takeaway learners can apply immediately in legacy modernization workflows.
:::
...
::: notes
This slide is part of the merged Brownfield Software Development section for the Thursday GE deck.
Use this slide to reinforce the core point, connect it to the previous slide, and set up the next transition.
Call out one practical takeaway learners can apply immediately in legacy modernization workflows.
:::
...
::: notes
This slide is part of the merged Safe Brownfield Coding || Don't Break Production. Use a Flag. section for the Thursday GE deck.
Use this slide to reinforce the core point, connect it to the previous slide, and set up the next transition.
Call out one practical takeaway learners can apply immediately in legacy modernization workflows.
:::
...
::: notes
This slide is part of the merged AI Implementation Workflow section for the Thursday GE deck.
Use this slide to reinforce the core point, connect it to the previous slide, and set up the next transition.
Call out one practical takeaway learners can apply immediately in legacy modernization workflows.
:::
...
::: notes
This slide is part of the merged AI Implementation Workflow || Don't Let the AI Drive Before You Check the Mirrors section for the Thursday GE deck.
Use this slide to reinforce the core point, connect it to the previous slide, and set up the next transition.
Call out one practical takeaway learners can apply immediately in legacy modernization workflows.
:::
...
::: notes
This slide is part of the merged Effective Prompts for Technical Debt || The Art of Complaining Productively to Your AI section for the Thursday GE deck.
Use this slide to reinforce the core point, connect it to the previous slide, and set up the next transition.
Call out one practical takeaway learners can apply immediately in legacy modernization workflows.
:::
...
::: notes
This slide is part of the merged Building a Backlog section for the Thursday GE deck.
Use this slide to reinforce the core point, connect it to the previous slide, and set up the next transition.
Call out one practical takeaway learners can apply immediately in legacy modernization workflows.
:::
...
::: notes
This slide is part of the merged Conformance and Gap Analysis || The Architectural Rules Lawyer Is In section for the Thursday GE deck.
Use this slide to reinforce the core point, connect it to the previous slide, and set up the next transition.
Call out one practical takeaway learners can apply immediately in legacy modernization workflows.
:::
...
::: notes
This slide is part of the merged Building a Technical Debt Backlog || Finally, an Excuse to File All Those Issues section for the Thursday GE deck.
Use this slide to reinforce the core point, connect it to the previous slide, and set up the next transition.
Call out one practical takeaway learners can apply immediately in legacy modernization workflows.
:::
...
::: notes
This slide is part of the merged Implementation Plan Prioritization || Security First: The Only Priority With No Exceptions section for the Thursday GE deck.
Use this slide to reinforce the core point, connect it to the previous slide, and set up the next transition.
Call out one practical takeaway learners can apply immediately in legacy modernization workflows.
:::
...
::: notes
This slide is part of the merged Addressing Technical Debt section for the Thursday GE deck.
Use this slide to reinforce the core point, connect it to the previous slide, and set up the next transition.
Call out one practical takeaway learners can apply immediately in legacy modernization workflows.
:::
...
::: notes
This slide is part of the merged Addressing Technical Debt with Copilot || Your Technical Debt Has an AI Payment Plan section for the Thursday GE deck.
Use this slide to reinforce the core point, connect it to the previous slide, and set up the next transition.
Call out one practical takeaway learners can apply immediately in legacy modernization workflows.
:::
...
::: notes
This slide is part of the merged Exercise: Addressing Technical Debt with Copilot || Ask Copilot to Clean Your Room section for the Thursday GE deck.
Use this slide to reinforce the core point, connect it to the previous slide, and set up the next transition.
Call out one practical takeaway learners can apply immediately in legacy modernization workflows.
:::
...
::: notes
This slide is part of the merged MFC to WPF - Legacy Conversion section for the Thursday GE deck.
Use this slide to reinforce the core point, connect it to the previous slide, and set up the next transition.
Call out one practical takeaway learners can apply immediately in legacy modernization workflows.
:::
