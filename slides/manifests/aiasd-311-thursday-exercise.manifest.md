...
sections:
  ...
  - name: Exercises
    decks:
      - slides\marp\exercise\exercises-title.deck.md

  - name: Brownfield Software Development Exercises
    decks:
  ...
  - name: Building a Backlog Exercises
    decks:
  ...
  - name: Addressing Technical Debt Exercises
    decks:
  ...
  - name: Multi-Implementation Comparison Exercises
    decks:
