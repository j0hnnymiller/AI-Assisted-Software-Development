...
- name: Intro to Copilot
  decks:
  - slides\marp\exercise\exercise-fork-and-clone-repositories.deck.md
  - slides\marp\hands-on-with-github-copilot-vs-code.deck.md
  - slides\marp\exercise\exercise-github-copilot-vscode-workflows.deck.md

- name: AI Assistance in Action
  decks:
  - slides\marp\vibe-coding.deck.md
  - slides\marp\exercise\exercise-calculator-project.deck.md
  - slides\marp\exercise\exercise-test-coverage-improvement.deck.md
  - slides\marp\exercise\exercise-test-driven-development.deck.md
  - slides\marp\ai-assisted-github-pull-requests.deck.md
...
- name: Adding AI Guardrails
  ...
  - slides\marp\exercise\exercise-copy-the-core-instructions.deck.md
  - slides\marp\exercise\exercise-create-an-instruction-file-for-evergreen-development.deck.md
  - slides\marp\exercise\exercise-context-related-issues.deck.md
  - slides\marp\exercise\exercise-delegating-work-to-copilot.deck.md
  - slides\marp\exercise\exercise-assigning-an-issue-to-copilot.deck.md
  ...
  - slides\marp\exercise\exercise-technology-inventory-instructions.deck.md
